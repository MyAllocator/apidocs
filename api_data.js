define({ "api": [
  ...
  },
  {
    "group": "3_API_Methods",
    "type": "POST",
    "url": "/BookingAcceptTentative",
    "title": "BookingAcceptTentative",
    "name": "BookingAcceptTentative",
    "version": "201803.0.0",
    "parameter": {
      "fields": {
        "Request": [
    ...
    "description": "<p>This method allows you to accept a tentative booking both in myallocator and the channel. Only few channels support this, check the 'api_tentative_bookings' flag on the ChannelList call to see which channels support this.</p> <p>Accepting a tentative booking will cause the myallocator booking to be updated (modified) and availability will be adjusted for the new confirmed booking (if automatic adjustments are enabled).</p>",
    "examples": [
      {
        "title": "JSON Example of accepting a tentative booking",
        "content": "{\n    \"Auth/UserToken\":\"\",\n    \"Auth/VendorId\":\"\",\n    \"Auth/VendorPassword\":\"\",\n    \"Auth/PropertyId\":\"\",\n\n    \"MyAllocatorId\":\"57333cd36dbf9a4f114dd781\"\n}",
        "type": "json"
      },
      {
        "title": "curl w/ JSON",
        "content": "curl https://api.myallocator.com/pms/v201408/json/BookingAcceptTentative -d@- <<EOJSON\njson=\n{\n    \"Auth/UserToken\":\"\",\n    \"Auth/VendorId\":\"\",\n    \"Auth/VendorPassword\":\"\",\n    \"Auth/PropertyId\":\"\",\n\n    \"MyAllocatorId\":\"57333cd36dbf9a4f114dd781\"\n}\nEOJSON",
        "type": "json"
      }
    ],
    "filename": "perllib/MyAllocator/API/Method/BookingActions.pm",
    "groupTitle": "3_API_Methods"
  },
  {
    "group": "3_API_Methods",
        ...
        "Response": [
          {
            ...
            "optional": false,
            "field": "Channels",
            "description": "<p>Object keyed by channel ID</p>"
          },
          {
            "group": "Response",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>&quot;true&quot; when the channel is in producion</p>"
          },
          {
            "group": "Response",
            "type": "String",
      ...
      "fields": {
        "Request": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "AddressLine1",
            "description": "<p>Street or other information locating the property, including house number if applicable.</p>"
          },
          {
            "group": "Request",
            "type": "String",
            "optional": true,
            "field": "AddressLine2",
            "description": "<p>Further address information</p>"
          },
          {
            "group": "Request",
            "type": "String",
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        ...
        {
          "title": "JSON Success Response",
          "content": "{\n    \"Success\": true,\n    \"RoomTypes\": [\n        {\n            \"Gender\": \"MI\",\n            \"Occupancy\": 1,\n            \"Description\": \"Longer description about the room\",\n            \"Label\": \"Short room name\",\n            \"Disabled\": \"false\",\n            \"ICalLink\": \"https://api.myallocator.com/callback/ota/air/v201506/ical?pid=1&rid=63&hash=foo12\",\n            \"Units\": 2,\n            \"RoomId\": 45844,\n            \"PrivateRoom\": \"true\",\n            \"PMSRoomId\": null\n        },\n        {\n            \"Gender\": \"MI\",\n            \"Occupancy\": 2,\n            \"Description\": \"yet another description of another room\",\n            \"Label\": \"test\",\n            \"Disabled\": \"true\",\n            \"ICalLink\": \"https://api.myallocator.com/callback/ota/air/v201506/ical?pid=1&rid=49&hash=9fe41\",\n            \"Units\": 1,\n            \"RoomId\": 45841,\n            \"PrivateRoom\": \"true\",\n            \"PMSRoomId\": null\n        },\n    ]\n}",
          "type": "json"
        }
      ]
    },
