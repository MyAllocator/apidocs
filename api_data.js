define({ api: [
  {
    ...
    "url": "{}",
    "title": "Welcome",
    "description": "<p>If you would like to use the myallocator.com PMS API you need to request a vendor ID and password first by emailing support@myallocator.com. The vendor_id + vendor_password will need to be submitted with every request.</p><p> Your customers need to create an account on myallocator.com before they can use the API (or you need to create one for them).  The credentials (user/password) can be stored by you and sent with each request, but it is recommend to permanently associate the user to the vendor credentials. By permanently associating the credentials you will not need to worry if the user changes their password.</p><p><strong> The Basics </strong></p><p> There are three API methods <em>most</em> systems will use.  The first one is GetProperties, which will return with a list of properties configured on myallocator.com.  You&#39;ll need the PropertyID from GetProperties for the other two methods.</p><p> The second method is GetRoomTypes, which returns a list of rooms configured on myallocator.com. These need to be mapped to the rooms in your software. Finally, and most importantly, SetAllocation uploads availability to the channels. The customer is required to add all their channel credentials on myallocator.com before being able to update availability.</p><p><strong> XML vs. JSON Requests  </strong></p><p> The service URL is <a href=\"http://api.myallocator.com/pms/v201408/(json|xml)/MethodName\">http://api.myallocator.com/pms/v201408/(json|xml)/MethodName</a>    In the URL above the Version is 201408, this version will periodically be changed as new features are added. The (json|xml) denotes the protocol (xml/json) for how requests/responses will be formatted.</p><p> MyAllocator can be accessed via REST using eithe a JSON or XML syntax. </p><ul><li>XML: Requests to our server need to be send using the POST method. The XML string should be stored in a parameter called &#39;xmlRequestString&#39;. Using standard HTML form encoding.</li><li>JSON offers simplified parsing and low transport overhead and is passed in the field &#39;json&#39; using standard HTML form encoding.</li></ul><p><strong> Using an SDK </strong>    Software Development Kits for several popular languages are available at <a href=\"http://github.com/myallocator\">http://github.com/myallocator</a> If you don&#39;t see your language listed please let us know and we&#39;ll add it.</p>",
    "error": {
      "examples": [
        {
  ...
  },
  {
    ...
    "name": "GetProperties",
    "group": "PMS",
    "description": "<p>Users on myallocator.com might have more than one property attached to their username. This request lists which properties are associated with the customer and provides a property ID, needed to update the availability of this property.</p>",
    "parameter": {
      "fields": {
        "Request": [
          {
    ...
    "examples": [
      {
        "title": "XML GetProperties Request",
        "content": "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<GetProperties>\n<Auth>\n<UserId>Customer User ID</UserId>\n<UserPassword>Customer Password</UserPassword>\n<VendorId>Your Vendor ID</VendorId>\n<VendorPassword>Your Vendor Password</VendorPassword>\n</Auth>\n</GetProperties>\n"
      },
      {
        "title": "JSON GetProperties Request",
        "content": "{}\n"
      }
    ],
    "success": {
      ...
      "examples": [
        {
          "title": "XML GetProperties Response Success",
  ...
  {
    "type": "get",
    "url": "/GetPropertyChannels",
    "title": "GetPropertyChannels",
    "name": "GetPropertyChannels",
    "group": "PMS",
    "parameter": {
      "fields": {
        "Request": [
  ...
  {
    "type": "get",
    "url": "/GetPropertyRooms",
    "title": "GetPropertyRooms",
    "name": "GetPropertyRooms",
    "group": "PMS",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "XML GetRoomTypes Request",
        "content": "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<GetRoomTypes>\n<Auth>\n  <UserId>Customer User ID</UserId>\n  <UserPassword>Customer Password</UserPassword>\n  <PropertyId>Property ID on myallocator.com</PropertyId>\n  <VendorId>Your Vendor ID</VendorId>\n  <VendorPassword>Your Vendor Password</VendorPassword>\n</Auth>\n</GetRoomTypes>\n"
      }
    ],
    "success": {
      ...
      "examples": [
        {
          "title": "XML GetRoomTypes Success Response:",
      ...
      "fields": {
        "Request": [
          ...
          },
          {
            ...
            "field": "RoomTypeId",
            "optional": false,
            "description": "<p>Room type id as returned by GetRoomTypes.</p>"
          },
          {
            "group": "Request",
            "type": "String",
    ...
    "examples": [
      {
        ...
        "content": "https://myallocator.com/callbacks/plogin.xt\n"
      }
    ],
    "parameter": {
      "fields": {
