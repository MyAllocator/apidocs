define({ "api": [
  ...
  },
  {
    "group": "3_API_Methods",
    "type": "POST",
    "url": "/BookingReportInvalidCC",
    "title": "BookingReportInvalidCC",
    "name": "BookingReportInvalidCC",
    "version": "201906.0.1",
    "description": "<p>Reports booking has invalid credit card with option to cancel the booking. Only very few channels support this, check the 'api_report_invalid_cc' flag on the ChannelList call to see which channels support this.</p>",
    "parameter": {
      "fields": {
        "Request": [
          {
        ...
        "Request": [
          {
            ...
            "optional": false,
            "field": "CancelBooking",
            "description": "<p>True if booking should be cancelled</p>"
          }
        ],
        "Response": [
          {
    ...
    "examples": [
      ...
      {
        "title": "curl",
        "content": "curl https://api.myallocator.com/pms/v201804/json/BookingReportBookingInvalidCC -d@- <<EOJSON\njson={\n    \"Auth/VendorId\":\"Your Vendor ID\",\n    \"Auth/VendorPassword\":\"Your Vendor Password\",\n    \"Auth/UserToken\":\"User token\",\n    \"Auth/PropertyId\":\"Property ID on myallocator.com\",\n    \"MyAllocatorId\":\"57333cd36dbf9a4f114dd781\",\n    \"CancelBooking\":true\n}\nEOJSON",
        "type": "json"
      }
    ],
    "error": {
  ...
  },
  {
    "group": "3_API_Methods",
    "type": "POST",
    "url": "/BookingReportNoShow",
    "title": "BookingReportNoShow",
    "name": "BookingReportNoShow",
    "version": "201804.0.1",
    "description": "<p>Reports booking as no show (a customer didn't come). Only very few channels support this, check the 'api_report_no_show' flag on the ChannelList call to see which channels support this.</p>",
    "parameter": {
      "fields": {
        "Request": [
          {
    ...
    "examples": [
      ...
      {
        "title": "curl",
        "content": "curl https://api.myallocator.com/pms/v201804/json/BookingReportBookingNoShow -d@- <<EOJSON\njson={\n    \"Auth/VendorId\":\"Your Vendor ID\",\n    \"Auth/VendorPassword\":\"Your Vendor Password\",\n    \"Auth/UserToken\":\"User token\",\n    \"Auth/PropertyId\":\"Property ID on myallocator.com\",\n    \"MyAllocatorId\":\"57333cd36dbf9a4f114dd781\"\n}\nEOJSON",
        "type": "json"
      }
    ],
    "error": {
      ...
      "fields": {
        "Request": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "EmailChannelBookingMode",
            "description": "<p>The setting of a property receiving an email upon receiving a booking. Defaults to &quot;if-required&quot;, which means we'll send confirmations for channels that do not do it themselves.</p>"
          },
          {
            "group": "Request",
            "type": "String",
  ...
  },
  {
    "group": "3_API_Methods",
    "type": "POST",
    "url": "/PropertyCurrencyOverrideList",
    "title": "PropertyCurrencyOverrideList",
    "name": "PropertyCurrencyOverrideList",
    "version": "201906.0.0",
    "description": "<p>List which currency exchange rate overrides the property has set.</p> <p><em>Note</em>: currently only returns currency overrides set for the property's default currency!</p>",
    "parameter": {
      "fields": {
        "Request": [
          {
            ...
            "optional": false,
            "field": "Auth/VendorId",
            "description": "<p>Id or the PMS vendor</p>"
          },
          {
            "group": "Request",
            "type": "String",
            "optional": false,
            "field": "Auth/VendorPassword",
            "description": "<p>Vendor's secret</p>"
          },
          {
            "group": "Request",
            "type": "Integer",
            "optional": false,
            "field": "Auth/PropertyId",
            "description": "<p>User's Property Id</p>"
          },
          {
            "group": "Request",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "FromCurrency",
            "description": "<p>Only show exchange rates where the source exchange rate matches FromCurrency.</p>"
          }
        ]
      }
    },
        ...
        "Response": [
          {
            ...
            "optional": false,
            "field": "Success",
            "description": "<p>True if call was successful. There are no call-specific errors.</p>"
          },
          {
            "group": "Response",
            "type": "Currency",
            "optional": false,
            "field": "MinimumRate",
            "description": "<p>Minimum supported rate. This value is unlikely to change.</p>"
          },
          {
            "group": "Response",
            "type": "Currency",
            "optional": false,
            "field": "MaximumRate",
            "description": "<p>Maximum supported rate. This value is unlikely to change.</p>"
          },
          {
            "group": "Response",
            "type": "Currency",
            "optional": false,
            "field": "Step",
            "description": "<p>Smallest supported increment between rates. This value is unlikely to change.</p>"
          },
          {
            "group": "Response",
            "type": "CurrencyCode",
            "optional": false,
            "field": "BaseCurrency",
            "description": "<p>Property's default currency</p>"
          },
          {
            "group": "Response",
            "type": "Container",
            "optional": false,
            "field": "ExchangeRates",
            "description": "<p>Container node. Array of objects.</p>"
          },
          {
            "group": "Response",
            "type": "CurrencyCode",
            "optional": false,
            "field": ".ExchangeRates.FromCurrency",
            "description": "<p>Currency code to convert from. ISO 4217.</p>"
          },
          {
            "group": "Response",
            "type": "CurrencyCode",
            "optional": false,
            "field": ".ExchangeRates.ToCurrency",
            "description": "<p>Currency code to convert to. ISO 4217.</p>"
          },
          {
            "group": "Response",
            "type": "Currency",
            "optional": false,
            "field": ".ExchangeRates.Rate",
            "description": "<p>Exchange rate between the two currencies.</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Success",
          "content": "{\n    \"RUID\": \"F55C6B3E-927C-11E9-8183-B4C95CF77523\",\n    \"ExchangeRates\": [\n        {\n            \"ToCurrency\": \"EUR\",\n            \"FromCurrency\": \"USD\",\n            \"Rate\": \"1.5430000000\"\n        },\n        {\n            \"Rate\": \"356.0000000000\",\n            \"FromCurrency\": \"USD\",\n            \"ToCurrency\": \"INR\"\n        }\n    ],\n    \"BaseCurrency\": \"USD\",\n    \"Step\": \"0.0000000001\",\n    \"MaximumRate\": \"9999999999.9999999999\",\n    \"MinimumRate\": \"0.0000000001\",\n    \"Success\": true\n}",
          "type": "json"
        }
      ]
    },
    "examples": [
      {
        "title": "JSON Request",
        "content": "{\n    \"Auth/VendorId\":137,\n    \"Auth/VendorPassword\":\"censored\",\n    \"Auth/PropertyId\":42,\n    \"Auth/UserToken\":\"censored\"\n}",
        "type": "json"
      },
      {
        "title": "curl",
        "content": "curl https://api.myallocator.com/pms/201906/json/PropertyCurrencyOverrideList -d@- <<ENDJSON\njson={\n    \"Auth/VendorId\":137,\n    \"Auth/VendorPassword\":\"censored\",\n    \"Auth/PropertyId\":42,\n    \"Auth/UserToken\":\"censored\",\n    \"FromCurrency\": \"USD\"\n}\nENDJSON",
        "type": "json"
      }
    ],
    "filename": "perllib/MyAllocator/API/Method/PropertyCurrencyOverride.pm",
    "groupTitle": "3_API_Methods"
  },
  {
    "group": "3_API_Methods",
    "type": "POST",
    "url": "/PropertyCurrencyOverrideUpdate",
    "title": "PropertyCurrencyOverrideUpdate",
    "name": "PropertyCurrencyOverrideUpdate",
    "version": "201906.0.0",
    "description": "<p>Set custom currency exchange rates for a property to be used instead of our automatically updated exchange rates.</p>",
    "parameter": {
      "fields": {
        "Request": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": ".ExchangeRates.Rate",
            "description": "<p>Exchange rate between the two currencies. Allows 10 decimal places. If you want to reset to automatic conversion set this to <code>auto</code>.</p>"
          }
        ]
      }
    },
    "success": {
      ...
      "examples": [
        {
          "title": "Success",
          "content": "{\n    \"Success\": true,\n    \"RUID\": \"4F712094-9127-11E9-A5D1-B4C95CF77523\"\n}",
          "type": "json"
        }
      ]
    },
    "examples": [
      {
        "title": "JSON Request",
        "content": "{\n    \"Auth/VendorId\":137,\n    \"Auth/VendorPassword\":\"censored\",\n    \"Auth/PropertyId\":42,\n    \"Auth/UserToken\":\"censored\",\n    \"ExchangeRates\": [\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"USD\", \"Rate\": 1.12 },\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"GBP\", \"Rate\": 0.895514 },\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"INR\", \"Rate\": \"auto\" }\n    ]\n}",
        "type": "json"
      },
      {
        "title": "curl",
        "content": "curl https://api.myallocator.com/pms/201906/json/PropertyCurrencyOverrideUpdate -d@- <<ENDJSON\njson={\n    \"Auth/VendorId\":137,\n    \"Auth/VendorPassword\":\"censored\",\n    \"Auth/PropertyId\":42,\n    \"Auth/UserToken\":\"censored\",\n    \"ExchangeRates\": [\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"USD\", \"Rate\": 1.12 },\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"GBP\", \"Rate\": 0.895514 },\n        { \"FromCurrency\": \"EUR\", \"ToCurrency\": \"INR\", \"Rate\": \"auto\" }\n    ]\n}\nENDJSON",
        "type": "json"
      }
    ],
    "error": {
      "examples": [
        {
          "title": "Error",
          "content": "{\n    \"Success\": false,\n    \"Errors\": [\n        {\n            \"ErrorMsg\": \"Invalid format (check for valid currency codes)\",\n            \"ErrorId\": 24,\n            \"ErrorTicket\": \"45F173C8-9129-11E9-AC70-B3C95CF77523\"\n        }\n    ],\n    \"RUID\": \"45F173C8-9129-11E9-AC70-B3C95CF77523\"\n}",
          "type": "json"
        }
      ]
    },
        ...
        "Request": [
          {
            ...
            "optional": true,
            "field": "List",
            "description": "<p>List of specific channels. By default all connected channels will be updated.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Request": [
          ...
          },
          {
            ...
            "description": "<p>Customer's family name</p>"
          },
          {
            "group": "Request",
            "type": "String",
