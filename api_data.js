define({ "api": [
  {
    ...
    "title": "Welcome",
    "name": "Welcome",
    "description": "<p><strong> Usage </strong></p> <p> To receive access to the myallocator.com PMS API you need to request a vendor-user and vendor-password by visiting:  <a href=\"https://www.myallocator.com/become-partner/\">https://www.myallocator.com/become-partner/</a></p> <p> The vendor_user + vendor_password uniquely identify your application and MUST be included with each request.</p> <p> <strong> Integration Guide </strong></p> <p> <a href=\"https://docs.google.com/a/ondeficarbrasil.com/document/d/1LvNA-w0VfCAmRsOC1qe2YV5HBtvu4lXa_BhyZVlP1pI/edit?usp=sharing\">https://docs.google.com/a/ondeficarbrasil.com/document/d/1LvNA-w0VfCAmRsOC1qe2YV5HBtvu4lXa_BhyZVlP1pI/edit?usp=sharing</a></p> <p> Your customers need to create an account on myallocator.com before they can use the API (or you need to create one for them).   The credentials (user/password) must be stored by you and sent with each request.</p> <p> <strong> Using an SDK </strong>  Software Development Kits for several popular languages are available at <a href=\"http://github.com/myallocator\">http://github.com/myallocator</a>   If you don&#39;t see your language listed please let us know and we&#39;ll add it. </p> <p> <strong> Getting Help </strong></p> <p> devhelp@myallocator.com  - please include your vendor-user, along with either an XML or JSON request suitable for curl.</p> <p> <strong> XML vs. JSON Requests  </strong></p> <p> The service URLs are:</p> <ul> <li>JSON - <a href=\"https://api.myallocator.com/pms/v201408/json/MethodName\">https://api.myallocator.com/pms/v201408/json/MethodName</a></li> <li><p>XML - <a href=\"https://api.myallocator.com/pms/v201408/xml/MethodName\">https://api.myallocator.com/pms/v201408/xml/MethodName</a></p> <p>In the URL above the Version is 201408, this version will periodically be changed as new features are added. The json|xml denotes the protocol for how request &amp; response will be formatted. </p> <p>MyAllocator can be accessed via REST using eithe a JSON or XML syntax. </p> </li> <li>XML: Requests to our server need to be send using the POST method. The XML string should be stored in a parameter called &#39;xmlRequestString&#39;. Using standard HTML form encoding.</li> <li>JSON offers simplified parsing and low transport overhead and is passed in the field &#39;json&#39; using standard HTML form encoding.</li> </ul> ",
    "error": {
      "examples": [
        {
